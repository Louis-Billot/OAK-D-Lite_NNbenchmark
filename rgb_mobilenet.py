...
f = open(datetime.now().strftime('%Y-%m-%d_%H-%M-%S.log'), "a")
...
with contextlib.ExitStack() as stack:
    ...
    for device_info in device_infos:
        ...
        while True:
            ...
            sysInfo = qSysInfo.tryGet()  # Blocking call, will wait until a new data has arrived
            if sysInfo is not None:
                f.write(str(sysInfo.chipTemperature.average) + "\n")
